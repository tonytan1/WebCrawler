 ...
 * <pre>MapFormatUtils.format("Hello {name}", map);</pre>
 * Or to have more control over it:
 * <pre>
 * Map m = new HashMap ();
 * m.put ("KEY", "value");
 * MapFormatUtils f = new MapFormatUtils (m);
 * f.setLeftBrace ("__");
 * f.setRightBrace ("__");
 ...
 * @see MessageFormat
 */
public class MapFormatUtils extends Format {
    ...
    */
    public MapFormatUtils(Map arguments) {
        super();
        setMap(arguments);
    }
    ...
    */
    public static String format(String pattern, Map arguments) {
        MapFormatUtils temp = new MapFormatUtils(arguments);
